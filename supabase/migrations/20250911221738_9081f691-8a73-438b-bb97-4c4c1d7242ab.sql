-- ============================================================================
-- FASE 1: PERFORMANCE, CACHE E SEGURANÇA - OTIMIZAÇÕES (CORRIGIDA v2)
-- ============================================================================

-- 1. HABILITAR EXTENSÃO TRIGRAM PARA BUSCA FUZZY (se não existir)
CREATE EXTENSION IF NOT EXISTS pg_trgm;

-- 2. ÍNDICES PARA PERFORMANCE DE BUSCA
...
-- Índice simples para ofertas por data (sem predicado com now())
