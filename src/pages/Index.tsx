...
const Index: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-app-gray">
      ...
      <div className="container mx-auto py-8 sm:py-16 px-4 sm:px-6">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
          <div className="bg-white p-4 sm:p-6 rounded-lg shadow-md text-center">
            ...
            <h3 className="text-lg sm:text-xl font-semibold mb-2">Adicione Produtos</h3>
          ...
          <div className="bg-white p-4 sm:p-6 rounded-lg shadow-md text-center">
            ...
            <h3 className="text-lg sm:text-xl font-semibold mb-2">Compare Preços</h3>
            <p className="text-sm sm:text-base text-gray-600">
          ...
          <div className="bg-white p-4 sm:p-6 rounded-lg shadow-md text-center sm:col-span-2 lg:col-span-1">
            ...
            <h3 className="text-lg sm:text-xl font-semibold mb-2">Economize</h3>
            <p className="text-sm sm:text-base text-gray-600">
            ...
            <div className="lg:w-1/2 mb-6 lg:mb-0 lg:pr-8">
              ...
              <ul className="space-y-3">
                <li className="flex items-start">
                  ...
                  <span className="text-sm sm:text-base">Economize tempo e dinheiro em suas compras de supermercado</span>
                </li>
                <li className="flex items-start">
                  <span className="text-app-green font-bold mr-2 mt-1">✓</span>
                  <span className="text-sm sm:text-base">Compare preços em diferentes mercados de forma rápida e fácil</span>
                </li>
                <li className="flex items-start">
                  <span className="text-app-green font-bold mr-2 mt-1">✓</span>
                  <span className="text-sm sm:text-base">Acompanhe seus gastos mensais e identifique oportunidades de economia</span>
                </li>
                <li className="flex items-start">
                  <span className="text-app-green font-bold mr-2 mt-1">✓</span>
                  <span className="text-sm sm:text-base">Interface intuitiva e fácil de usar</span>
                </li>
              </ul>
            </div>
      ...
      <footer className="bg-app-dark text-white py-6 sm:py-8">
            ...
            <div className="grid grid-cols-2 gap-6 sm:gap-8 sm:grid-cols-3">
              <div>
                ...
                <ul className="space-y-1">
                  <li><a href="/" className="text-gray-300 hover:text-white text-sm">Início</a></li>
