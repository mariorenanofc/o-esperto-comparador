        ...
        <div className="bg-white rounded-lg shadow-md p-8 space-y-6">
          <section>
            ...
            <ul className="list-disc list-inside text-gray-600 space-y-2">
              <li>Informações de conta (fornecidas pelo Clerk para autenticação)</li>
              <li>Contribuições de preços (produto, loja, preço, localização)</li>
              <li>Feedbacks e sugestões (nome, email, telefone quando fornecidos voluntariamente)</li>
          ...
          <section>
            ...
            <p className="text-gray-600 mb-3">Suas informações são utilizadas para:</p>
            <ul className="list-disc list-inside text-gray-600 space-y-2">
          ...
          <section>
            ...
            <ul className="list-disc list-inside text-gray-600 space-y-2">
              <li>Contribuições de preços são públicas para todos os usuários</li>
              <li>Nome do contribuidor é exibido de forma abreviada (ex: "João S.")</li>
              <li>Dados pessoais completos são visíveis apenas para administradores</li>
              <li>Não vendemos ou compartilhamos dados com terceiros para fins comerciais</li>
            </ul>
          </section>

          <section>
            <h2 className="text-2xl font-semibold mb-4">4. Retenção de Dados</h2>
            <p className="text-gray-600">
              Implementamos uma política de retenção limitada:
            </p>
            <ul className="list-disc list-inside text-gray-600 space-y-2 mt-3">
              <li>Contribuições de preços são automaticamente removidas após 24 horas</li>
              <li>Feedbacks são mantidos por tempo limitado para análise administrativa</li>
          ...
          <section>
            ...
            <p className="text-gray-600">
              ...
              autenticação segura através do Clerk, armazenamento temporário de dados sensíveis, 
              e acesso restrito a informações pessoais.
            </p>
          </section>

          <section>
            <h2 className="text-2xl font-semibold mb-4">7. Cookies e Tecnologias</h2>
            <p className="text-gray-600">
              Utilizamos cookies e tecnologias similares para melhorar a experiência do usuário, 
              manter sessões de login, e analisar o uso da plataforma.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-gray-600">
              ...
              através da seção "Sugira Melhorias" em nossa página de contribuições.
            </p>
          </section>
