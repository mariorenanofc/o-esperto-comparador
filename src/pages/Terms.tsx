        ...
        <div className="bg-white dark:bg-gray-950 rounded-lg shadow-md p-8 space-y-6">
          <section>
            ...
            <p className="text-gray-600">
              Ao utilizar o Comparador Online, você concorda com estes termos de
          ...
          <section>
            ...
            <p className="text-gray-600 mb-3">
              O Comparador Online é uma plataforma colaborativa que permite aos
              usuários:
            </p>
            <ul className="list-disc list-inside text-gray-600 space-y-2">
              <li>
                Comparar preços de produtos em diferentes estabelecimentos
              </li>
              <li>
                Contribuir com informações de preços encontrados durante suas
                compras
              </li>
          ...
          <section>
            ...
            <p className="text-gray-600 mb-3">
              As contribuições de preços são temporárias e válidas apenas por 24
              horas, sendo automaticamente removidas após esse período. Ao
              contribuir, você:
            </p>
            <ul className="list-disc list-inside text-gray-600 space-y-2">
              <li>
                Garante que as informações fornecidas são verdadeiras e precisas
              </li>
              <li>
                Entende que suas contribuições serão verificadas por outros
                usuários
              </li>
              <li>
                Aceita que suas contribuições podem ser moderadas ou removidas
              </li>
              <li>
                Concorda que as informações serão compartilhadas com a
                comunidade
              </li>
            </ul>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc list-inside text-gray-600 space-y-2">
              ...
              <li>
                Não utilizar a plataforma para fins comerciais não autorizados
              </li>
          ...
          <section>
            ...
            <p className="text-gray-600">
              O Comparador Online é uma plataforma informativa. Não nos
              responsabilizamos por: decisões de compra baseadas nas informações
              da plataforma, preços incorretos fornecidos por usuários, ou
              perdas financeiras decorrentes do uso da plataforma.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-gray-600">
              ...
              momento. As alterações serão comunicadas através da plataforma.
            </p>
          </section>
