          ...
          {PLANS.map((plan) => (
            <Card
              ...
              className={`group relative overflow-hidden transition-all duration-500 hover:scale-105 hover:-rotate-1 ${
                plan.popular
                  ? "border-emerald-400 border-2 shadow-2xl bg-gradient-to-br from-emerald-50 via-white to-green-50 dark:from-emerald-900/20 dark:via-gray-800 dark:to-green-900/20"
              ...
              } ${currentPlan === plan.id ? "ring-4 ring-blue-400/50" : ""}`}
            >
              ...
              {plan.popular && (
                <Badge className="absolute -top-3 left-1/2 transform -translate-x-1/2 bg-gradient-to-r from-emerald-500 to-green-600 shadow-lg animate-pulse">
              ...
              {currentPlan === plan.id && (
                <Badge className="absolute -top-3 right-4 bg-gradient-to-r from-blue-500 to-cyan-600 shadow-lg">
                  ✅ Seu Plano
                </Badge>
              )}
